...
// 		document.getElementById("paid-shipping").style.display = "none";
    ...
    var threshold = document.getElementById("threshold").innerHTML;
  
     if (cart.item_count >= threshold) {
		document.getElementById("paid-shipping").style.display = "none";
      }
      else{
        document.getElementById("threshold").innerHTML = (threshold - cart.item_count);
